...
namespace IVAUDToolBox
{
    public class Utils
    {
        ...
        public static ListViewItem createPropertyListItem(string property, string value)
        {
            ListViewItem lvi;
            lvi = new ListViewItem(property);
            lvi.UseItemStyleForSubItems = false;
            lvi.SubItems.Add(value).Font = new System.Drawing.Font("Tahoma", 8f, System.Drawing.FontStyle.Bold);
            return lvi;
        }

        public static ListViewItem createListItem(string index, string name, string duration, string sampleRate, string offset, string size)
        {
            ListViewItem lvi;
            lvi = new ListViewItem(index);
            lvi.UseItemStyleForSubItems = false;
            lvi.SubItems.Add(name);
            lvi.SubItems.Add(duration);
            lvi.SubItems.Add(sampleRate);
